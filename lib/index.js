...
var Dis = (function () {
  ...
  _createClass(Dis, [{
    key: 'register',
    value: function register(initial, reduce, compare) {
      var _context;
      ...
      if (typeof initial === 'function') {
        // using shorthand es6 notation
        compare = reduce;
        reduce = initial;
        state = initial = reduce(undefined, {});
      }
      reduce = reduce || function (x) {
        return x;
      };
      ...
      var reg = (_context = this.$).register.bind(_context);
